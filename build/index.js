...
(function() {
    ...
    // *
    //loading now digit watch
    const dateNow = new Date();
    const hour = String(dateNow.getHours()).padStart(2, '0');
    const min = String(dateNow.getMinutes()).padStart(2, '0');
    const sec = String(dateNow.getSeconds()).padStart(2, '0');
     //set hour
     setTime(firstHourDigit, lastHourDigit, hour);
     //set minutes
     setTime(firstMinuteDigit, lastMinuteDigit, min);
     //set seconds
     setTime(firstSecondDigit, lastSecondDigit, sec);

    const data = String(dateNow.getDate()).padStart(2, '0');
    const year = String(dateNow.getFullYear()).padStart(2, '0');
    dateDiv.innerHTML = `${data} ${months[dateNow.getMonth()]} ${year}`;
    //
    // *
    ...
    function DigitalWatch() {
        setInterval(() => {
            ...
            document.querySelector('.time-image-one').src = "./public/images/colon.png";
            document.querySelector('.time-image-two').src = "./public/images/colon.png";
